...
const FRENCH_TO_SPOONACULAR: Record<string, string> = {
  ...
  "baies de genievre": "juniper-berries",
  "clou de girofle": "cloves",
  "poivre de sichuan": "sichuan-pepper",
  "cinq epices": "five-spice-powder",
  ...
  "semoule": "semolina",
  "polenta": "polenta",
  "vermicelle": "rice-noodles",
  "nouilles": "noodles",
  "nouilles de riz": "rice-noodles",
  "feuille de riz": "rice-paper",
  "feuille de brick": "phyllo-dough",
  "pate feuilletee": "puff-pastry",
  "pate brisee": "pie-crust",
  "pate sablee": "shortcrust-pastry",
};
